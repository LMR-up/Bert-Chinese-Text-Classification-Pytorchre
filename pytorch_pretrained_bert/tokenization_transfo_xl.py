...
class LMOrderedIterator(object):
    def __init__(self, data, bsz, bptt, device='cpu', ext_len=None):
        """
            other_data -- LongTensor -- the LongTensor is strictly ordered
        """
        self.bsz = bsz
        self.bptt = bptt
        ...
        # Evenly divide the other_data across the bsz batches.
...
class LMShuffledIterator(object):
    def __init__(self, data, bsz, bptt, device='cpu', ext_len=None, shuffle=False):
        """
            other_data -- list[LongTensor] -- there is no order among the LongTensors
        """
        self.data = data
    ...
    def stream_iterator(self, sent_stream):
        # streams for each other_data in the batch
        ...
        while True:
            # other_data   : [n_retain+bptt x bsz]
            # target : [bptt x bsz]
